...
export const ARCADE_SPRITES = {
  gustavaxDemon:{file:'demon',folder:'heroes/talents/gustavax',cols:4,rows:4,height:175,rowCuts:[0,.24,.485,.745,1],cleanComponents:true},
  gustavaxBossForm:{file:'boss',folder:'heroes/talents/gustavax',cols:4,rows:4,height:175,rowCuts:[0,.255,.505,.75,1]},
  gustavaxWrestler:{file:'wrestler',folder:'heroes/talents/gustavax',cols:4,rows:4,height:190,rowCuts:[0,.285,.51,.775,1],cleanComponents:true},
  gustavaxMinions:{file:'minions',folder:'heroes/talents/gustavax',cols:4,rows:4,height:100,rowCuts:[0,.255,.51,.745,1]},
  gustavaxFX:{file:'fx',folder:'heroes/talents/gustavax',cols:4,rows:4,height:90},
  lorenzoChimera: { file: 'chimera', folder: 'heroes/talents/lorenzo', cols: 4, rows: 4, height: 170, rowCuts:[0,.26,.51,.755,1] },
  lorenzoPigeon: { file: 'pigeon', folder: 'heroes/talents/lorenzo', cols: 4, rows: 4, height: 105, rowCuts:[0,.235,.46,.72,1], columnCuts:[0,.24,.54,.76,1] },
  lorenzoSkull: { file: 'skull', folder: 'heroes/talents/lorenzo', cols: 4, rows: 4, height: 170 },
  lorenzoFX: { file: 'fx', folder: 'heroes/talents/lorenzo', cols: 4, rows: 4, height: 75 },
  kikorPainter: {file:'painter',folder:'heroes/talents/kikor',cols:4,rows:4,height:175,rowCuts:[0,.28,.535,.76,1],rowColumns:{1:[0,.25,.56,.77,1],3:[0,.25,.57,.8,1]}},
  kikorSummoner: {file:'summoner',folder:'heroes/talents/kikor',cols:4,rows:4,height:175,rowCuts:[0,.275,.53,.74,1]},
  kikorBike: {file:'bike',folder:'heroes/talents/kikor',cols:4,rows:4,height:155,rowCuts:[0,.27,.52,.75,1]},
  kikorMinions: {file:'minions',folder:'heroes/talents/kikor',cols:4,rows:4,height:72,rowCuts:[0,.29,.55,.81,1],cleanComponents:true,cells:{2:[.5,0,.79,.29],6:[.5,.29,.8,.55]}},
  kikorFX: {file:'fx',folder:'heroes/talents/kikor',cols:4,rows:4,height:75},
  joPallet: {file:'pallet',folder:'heroes/talents/jo',cols:4,rows:4,height:150},
  joFire: {file:'fire',folder:'heroes/talents/jo',cols:4,rows:4,height:175,rowCuts:[0,.26,.505,.74,1]},
  joWeasel: {file:'weasel',folder:'heroes/talents/jo',cols:4,rows:4,height:175,rowCuts:[0,.27,.53,.76,1]},
  joFX: {file:'fx',folder:'heroes/talents/jo',cols:4,rows:4,height:75},
  yanuBeast: { file:'beast',folder:'heroes/talents/yanu',cols:4,rows:4,height:175,rowCuts:[0,.28,.54,.755,1],rowColumns:{1:[0,.275,.5,.75,1],3:[0,.255,.5,.75,1]} },
  yanuFluo: { file:'fluo',folder:'heroes/talents/yanu',cols:4,rows:4,height:175,rowCuts:[0,.26,.51,.75,1] },
  yanuPlant: { file:'plant',folder:'heroes/talents/yanu',cols:4,rows:4,height:175,cleanComponents:true,rowCuts:[0,.28,.535,.75,1],rowColumns:{1:[0,.25,.56,.75,1]},cells:{13:[.245,.75,.56,1],14:[.53,.75,.75,1]} },
  yanuFX: { file:'fx',folder:'heroes/talents/yanu',cols:4,rows:4,height:100,rowCuts:[0,.26,.465,.74,1] },
  jualosCommercial: { file: 'commercial', folder: 'heroes/talents/jualos', cols: 4, rows: 4, height: 175, rowCuts:[0,.27,.51,.72,1], rowColumns:{1:[0,.25,.545,.75,1],3:[0,.25,.545,.75,1]} },
  jualosPig: { file: 'pig', folder: 'heroes/talents/jualos', cols: 4, rows: 4, height: 130, cleanComponents:true, rowCuts:[0,.275,.50,.75,1], cells:{0:[0,0,.26,.275],1:[.25,0,.52,.275],2:[.5,0,.77,.275],4:[0,.275,.27,.5],8:[0,.5,.27,.75],9:[.245,.5,.53,.75],10:[.5,.5,.77,.75],11:[.76,.485,1,.75],12:[0,.75,.27,1],14:[.49,.75,.77,1],15:[.73,.75,1,1]} },
  jualosGuitar: { file: 'guitar', folder: 'heroes/talents/jualos', cols: 4, rows: 4, height: 175, rowCuts:[0,.275,.53,.735,1], rowColumns:{1:[0,.25,.57,.77,1],3:[0,.25,.575,.77,1]} },
  jualosFX: { file: 'fx', folder: 'heroes/talents/jualos', cols: 4, rows: 4, height: 75, rowCuts:[0,.275,.545,.76,1] },
  karonuxGolf: { file: 'golf', folder: 'heroes/talents', cols: 4, rows: 4, height: 110 },
  karonuxIce: { file: 'ice', folder: 'heroes/talents', cols: 4, rows: 4, height: 155, rowCuts: [0,.28,.53,.755,1] },
  karonuxHandi: { file: 'handi-combat', folder: 'heroes/talents', cols: 4, rows: 4, height: 155 },
  karonuxFX: { file: 'fx', folder: 'heroes/talents', cols: 4, rows: 4, height: 110, rowCuts: [0,.30,.58,.79,1] },
