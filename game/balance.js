...
export const BALANCE = {
  ...
  bosses: {
    gustavax: {hp:3600,power:29.7,phases:[.65,.3],recovery:1.7},
    karonux: { hp: 1280, power: 22, carHp: 480, phases: [.4], recovery: 1.6, healing: 36, healUses: 3 },
    kikor: { hp: 1240, power: 22, phases: [.5], recovery: 1.25, creationHp: 70 },
    yanu: { hp: 1300, power: 24.2, phases: [.5], recovery: 1.5 },
    lorenzo: { hp: 1400, power: 26.4, phases: [.6], recovery: 1.3, sofaHp: 360 },
    jo: { hp: 1440, power: 26.4, phases: [.5], recovery: 1.4 },
    jualos: { hp: 1600, power: 28.6, phases: [.5], recovery: 1.3 },
  },
