...
export const GUSTAVAX_ACTIVE={executiveCombo:1.2,cigarRain:1.1,chairRush:2.8,smokeCharge:.95,deskSweep:1.1,deskSlam:.75,lastWord:2.85};
export function gustavaxPose(a){
  ...
  }else if(a.recovering>0)frame=phase===1?(a.recoveryKind==='angry'?11:13):phase===2?(a.recoveryKind==='crash'&&a.recovering>2.6?7:13):a.recoveryKind==='lastWord'?14:11;
  else if(a.action==='hurt'&&a.actionTime<.2)frame=phase===1?12:phase===2?14:11;
