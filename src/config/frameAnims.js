...
export const FRAME_ANIM_CHARS = {
  ...
  lorenzo: {
    idle: ['lorenzo_idle (1)', 'lorenzo_idle (2)', 'lorenzo_idle (3)', 'lorenzo_idle (4)'],
    walk: ['lorenzo_marche (1)', 'lorenzo_marche (2)', 'lorenzo_marche (3)', 'lorenzo_marche (4)'],
    run: [
      'lorenzo_court (1)',
      'lorenzo_court (2)',
      'lorenzo_court (3)',
    ...
    punch: ['lorenzo_poing (1)', 'lorenzo_poing (2)', 'lorenzo_poing (3)', 'lorenzo_poing (4)'],
    kick: ['lorenzo_pied (1)', 'lorenzo_pied (2)', 'lorenzo_pied (3)', 'lorenzo_pied (4)'],
    jump: ['lorenzo_saute (1)', 'lorenzo_saute (2)', 'lorenzo_saute (3)', 'lorenzo_saute (4)'],
    fall: [
      'lorenzo_tombe (1)',
      'lorenzo_tombe (2)',
      'lorenzo_tombe (3)',
